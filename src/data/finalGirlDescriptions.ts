...
export const FINAL_GIRL_DESCRIPTIONS: Record<string, string> = {
  ...
  'Christie': `A trust fund kid, Christie lived a carefree life of partying and luxury. She partied her way around the world. With each week that passed she fell further into the wide mouth of debauchery. Pleasure was her only purpose. There was never an off moment for her—she was always either on a bender or recovering from the night before. She lacked remorse for those she hurt in her pursuit of "happiness." Her life was an endless search for the next high. One night in particular, drunk out of her mind, she decided to drive. The memories were vague. Had she died? Did she kill someone? It was a blur. But as her soul awoke in a labyrinthine Hellscape, something shone forth from within her dark heart. Purpose. Redemption. Maybe, she thought, she could save the world from this realm of agony. It was time to do something good.`,
  
  'Kenzie': `Kenzie lived a very quiet life in a small town—she went to school and worked evening shifts at the mall. A simple life. The only odd thing in her life was her father. He had always been a recluse, keeping to himself and his books. His study was always locked and she never thought much of the strange noises coming from the room at night, that is until he went missing. She and her mother had gone through his things. Books on every occult subject littered his study; the only thing that wasn't a book was a large blade. They weren't sure where he had gotten it or what it was for. After months of searching for him with no luck, Kenzie took to her father's books. Countless hours of study culminated in a ritual with her father's blade. With it, she opened a door that could not be closed. She knew the only way to close it was from inside.`,
